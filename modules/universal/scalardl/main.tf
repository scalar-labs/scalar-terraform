...
resource "null_resource" "scalardl_container" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "echo export SCALAR_CASSANDRA_USER=${var.cassandra_user} >> env",

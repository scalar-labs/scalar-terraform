...
| privileged_target_group_arn | The target group ID to attach resources to for the Scalar DL privileged access. If NLB is enabled this field is required | `list` | `[]` | no |
...
| target_group_arn | The target group ID to attach resources to. If NLB is enabled this field is required | `list` | `[]` | no |
